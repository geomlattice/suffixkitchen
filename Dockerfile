...
COPY suffix/lib /var/www/suffix/lib 
COPY suffix/assets /var/www/suffix/assets 
COPY suffix/mix.exs /var/www/suffix
COPY suffix/config/dev.exs /var/www/suffix/config/
COPY suffix/config/config.exs /var/www/suffix/config/
RUN mix deps.get
RUN mix compile
